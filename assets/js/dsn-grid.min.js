    ...
    isMobile: function (e = !0) {
        ...
        return {
            addParrlax: function (n) {
                ...
                let i = t.convertToJQuery(n.id), o = new ScrollMagic.Scene({
        ...
        return window.Scrollbar.get(document.querySelector("#dsn-scrollbar")) ? $effectScroll.getScrollbar().limit.y - document.body.scrollHeight : document.body.scrollHeight - $wind.height()
        ...
        let o = window.performance.timing, r = -1 * (o.loadEventEnd - o.navigationStart) / 1e3 % 50 * 10, s = e,
            a = t > e ? 1 : -1, l = Math.abs(Math.floor((r + n) / 100)), d = setInterval((function () {
                s += a, i(s), s >= t && clearInterval(d)
            }), l);
        return d
        ...
        let o = t[0].getBoundingClientRect(), r = e.pageX - o.left, s = e.pageY - o.top,
        ...
        let r = e.target || e, s = e.element || e.target || e;
        if (!s.length) return;
        ...
        if (!(n.length <= 0) || e.imgs.length) return delete t.parent, e.parent = n.get(0), n = null, new function (e, t, n) {
            var i, o = t.parent || console.warn("no parent"),
                r = t.displacement || console.warn("displacement image missing"), s = [], a = this, l = !1,
                d = e.convertToJQuery(n.nextEl), c = e.convertToJQuery(n.prevEl), h = 0, u = 0;
            ...
            function g(e, t) {
                l = !0, void 0 !== n.onStart && n.onStart.bind(this, e, t)(), f.bind(this)(e, !0)
            }
            ...
            function m() {
                this.mat.uniforms.texture.value = s[u], this.mat.uniforms.dispFactor.value = 0, l = !1, void 0 !== n.onEnd && n.onEnd.bind(this)()
            }
            ...
            $(o).addClass("three-js-loader"), t = $.extend(!0, {
                ...
                void 0 === this.renderer || l || (this.mat.uniforms.effectFactor.value = t.intensity, h = u, u = (u + 1) % s.length, this.changeTo(u))
            }, this.prev = function () {
                void 0 === this.renderer || l || (this.mat.uniforms.effectFactor.value = -1 * t.intensity, h = u, u = 0 === u ? s.length - 1 : Math.abs((u - 1) % s.length), this.changeTo(u))
            }, this.changeTo = function (e) {
                this.mat.uniforms.texture2.value = s[e], gsap.to(this.mat.uniforms.dispFactor, t.speedIn, {
                    value: 1,
                    ease: t.easing,
                    onStart: g.bind(this, u, h),
                    onUpdate: v.bind(this, u, h),
                    onComplete: m.bind(this, u, h)
                })
            }
        }(this, e, t)
        ...
        $(document).find("[data-dsn-" + e + "]").each((function () {
            let t = $(this), n = dsnGrid.getData(t, "srcset", ""), i = $("<img>");
        ...
        return {
            set: function (t, n, i) {
                ...
                n = e.hashCode(n).crypt(), document.cookie = t + "=" + n + ";" + r + ";path=/", o = r = t = n = i = null
            }, get: function (t) {
                let n = (t = "grida_" + t) + "=", i = decodeURIComponent(document.cookie), o = i.split(";");
                for (let t = 0; t < o.length; t++) {
                    let r = o[t];
                    for (; " " === r.charAt(0);) r = r.substring(1);
                    if (0 === r.indexOf(n)) {
                        let t = r.substring(n.length, r.length);
                        return r = o = i = n = null, e.hashCode(t).decrypt()
                    }
                }
                return o = i = n = null, !1
            }, remove: function (e) {
        ...
        return this.cookie().get("style_test")
    }, setStyle: function (e) {
        this.cookie().set("style_test", e, 1)
    }, executeStyle: function () {
        const e = this.getStyle();
        e ? "dark" === e && $body.hasClass("v-dark") || this.changeColor() : this.setStyle($body.hasClass("v-dark") ? "dark" : "light")
    }, changeColor: function () {
        const e = $(".v-dark"), t = $(".v-light");
        $body.toggleClass("v-dark"), e.removeClass("v-dark").addClass("v-light"), t.addClass("v-dark").removeClass("v-light")
    }, hashCode: function (e, t = 10) {
        return e += "", {
            crypt: function () {
                let n = "";
                for (let i, o = 0; o < e.length; o++) i = e.charCodeAt(o) + t, n += String.fromCharCode(i);
                return n
            }, decrypt: function () {
                let n = "";
                for (let i, o = 0; o < e.length; o++) i = e.charCodeAt(o) - t, n += String.fromCharCode(i);
        ...
        return e instanceof jQuery == !1 && (e = jQuery(e)), n = this.getUndefinedVal(n, {}), i = this.getUndefinedVal(n.sizeX, "105%"), o = this.getUndefinedVal(n.sizeY, "105%"), s = this.getUndefinedVal(n.left, "-5%"), a = this.getUndefinedVal(n.top, "-5%"), r = this.getUndefinedVal(n.move, 100), e.css({
            ...
            var o = i.clientX / jQuery(this).width() - .5, s = i.clientY / jQuery(this).height() - .5;
        ...
        if (i <= s && void 0 !== n.action) {
            var d = i - s, c = d / l, h = s / (t.height() + i + o);
            n.action({scroll: d, position: c, targetEnd: l, ScrollTop: s, num: h})
        }
        return h
    }, setPositionMoveSection: function (e, t, n) {
        if (void 0 !== e) {
            var i = e.offset(), o = void 0 === i ? 0 : i.top;
        ...
        var i = e.html().trim().split(" "), o = "";
        e.html("");
        for (var r = 0; r < i.length; r++) if (i[r].length > 0) {
        ...
        var a = r.html(), l = $('<div class="icon-circle"></div>'),
        ...
        e.isScroller(!0) && (o = e.getScrollbar()), e.getListener((function (e) {
            let n = 0, i = $(document).height() - window.$wind.height();
...
window.$dsnOption = {heightScroll: dsnGrid.getHeightScroll()}, jQuery.fn.dsnGridStyleObject = function () {
    return this.css(["padding-left", "padding-right", "padding-top", "padding-bottom", "font-size", "font-style", "font-weight", "line-height", "letter-spacing", "color"])
};
